...
function snsVideoRoots(wechatBaseDir: string): string[] {
...
function dataUrlOf(path: string): string | null {
  try {
...
function firstExisting(root: string, sub: string, rest: string): string | null {
...
function firstExistingVideo(root: string, sub: string, rest: string): string | null {
