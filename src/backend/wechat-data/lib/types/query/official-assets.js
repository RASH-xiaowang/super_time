 ...
 */
export function queryOfficialAssets(decryptedDir) {
    const sig = [
        ...
        for (const f of readdirSync(dir)) {
            ...
            try {
                ...
                for (const table of tables) {
                    ...
                    if (!cols.has('create_time') || !cols.has('local_type'))
                        continue;
                    try {
                        ...
                        for (const r of rows) {
                            ...
                            if (lt === 49) {
                                ...
                                if (t > 0 && (acc.lastArticleTime == null || t > acc.lastArticleTime))
                                    acc.lastArticleTime = t;
                            }
                        }
                    }
                    catch { /* skip */ }
...
//# sourceMappingURL=official-assets.js.map