...
import { parseSnsXml } from "./moments.js";
import { cachedBySig, contactMeta, fileSigOf } from "./meta.js";
 ...
 */
export function queryMomentsMonthly(decryptedDir, author, authorName) {
    ...
    try {
        ...
        for (const r of rows) {
            if (authorName) {
                ...
                if ((names?.get(u) || u || '未知') !== authorName)
                    continue;
            }
...
//# sourceMappingURL=moments-monthly.js.map