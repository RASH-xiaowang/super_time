...
export declare const PLAIN_TEXT_EXTS: readonly ["txt", "md", "markdown", "markdn", "text", "log", "csv", "tsv", "json", "jsonl", "ndjson", "yaml", "yml", "xml", "srt", "vtt", "ini", "conf"];
/** A' 档：HTML，去标签取可见文本，零依赖。 */
export declare const HTML_EXTS: readonly ["html", "htm", "xhtml"];
/**
 ...
 */
export declare const PENDING_PARSER_EXTS: readonly ["pdf", "docx", "xlsx", "xls"];
/**
 * C 档：本期只登记元数据，不解析正文。
 *
 ...
 */
export declare const REGISTER_ONLY_EXTS: readonly ["png", "jpg", "jpeg", "webp", "bmp", "gif", "tif", "tiff"];
/**
 ...
 */
export declare const ACCEPTED_EXTS: readonly string[];
/**
 * 取小写扩展名（不含点）。无扩展名时返回 `''`。
 *
 ...
 */
export declare function isParsableExt(ext: string): boolean;
/**
 * 该扩展名是否在白名单内（可被登记）。
 * @param ext - 小写扩展名。
 * @returns 在白名单内时为 true。
 */
export declare function isAcceptedExt(ext: string): boolean;
