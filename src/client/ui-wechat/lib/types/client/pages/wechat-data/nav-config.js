export const NAV_GROUPS = [
    ...
    },
    {
        label: '报告与总结',
        items: [
            { tab: 'annual', label: '年度报告', icon: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>' },
            { tab: 'period', label: '周期报告', icon: '<rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 2v4M16 2v4M3 9h18"/><path d="M7 14h4M13 14h4M7 17h4"/>' },
    ...
    },
    {
        ...
        items: [
            ...
            { tab: 'monitor', label: '群聊监控', icon: '<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>' },
            { tab: 'revoked', label: '撤回消息', icon: '<path d="M3 7v6h6"/><path d="M21 17a9 9 0 0 0-15-6.7L3 13"/><path d="M21 3v6h-6"/>' },
        ],
    },
    {
        label: '联系人与社交',
    ...
    },
    {
        label: '内容资产',
        items: [
            { tab: 'favorites', label: '我的收藏', icon: '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>' },
            { tab: 'emoticons', label: '表情包', icon: '<circle cx="12" cy="12" r="10"/><circle cx="8" cy="10" r="1"/><circle cx="16" cy="10" r="1"/><path d="M8 15a4 4 0 0 0 8 0"/>' },
            { tab: 'files', label: '文件资产', icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>' },
            { tab: 'mediaassets', label: '媒体资产', icon: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>' },
            { tab: 'officialassets', label: '公众号文章', icon: '<path d="M6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM18 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM12 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>' },
        ],
    },
    {
        label: '资金与存储',
        items: [
            { tab: 'ledger', label: '资金账本', icon: '<rect x="2" y="6" width="20" height="14" rx="2"/><path d="M2 10h20M2 14h20"/><path d="M7 18h10"/>' },
            { tab: 'records', label: '转账红包', icon: '<rect x="3" y="4" width="18" height="16" rx="2"/><line x1="7" y1="8" x2="17" y2="8"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="7" y1="16" x2="13" y2="16"/>' },
            { tab: 'storage', label: '存储分析', icon: '<path d="M22 12H2"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" y1="16" x2="6.01" y2="16"/><line x1="10" y1="16" x2="10.01" y2="16"/>' },
        ],
    },
    {
        label: '洞察与行动',
        items: [
            { tab: 'groupinsights', label: '群聊洞察', icon: '<circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="12" cy="18" r="3"/><line x1="8.5" y1="7.5" x2="10.5" y2="15.5"/><line x1="15.5" y1="7.5" x2="13.5" y2="15.5"/>' },
            ...
            { tab: 'assetinsights', label: '收藏表情统计', icon: '<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>' },
    ...
    },
    {
        ...
        items: [
            ...
            { tab: 'hook', label: '原图链路自检', icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h3M12 17H8M16 13h1M17 17h1"/>' },
...
//# sourceMappingURL=nav-config.js.map