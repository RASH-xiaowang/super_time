...
export const CHINA_BBOX = { lonMin: 73, lonMax: 135, latMin: 18, latMax: 54 };
/**
 ...
 * @returns projected x/y within the viewBox.
 */
export function projectBBox(lon, lat, bbox) {
 ...
 */
export function smoothClosedPath(points, proj = project) {
    if (points.length < 3)
        return '';
 ...
 */
export function provinceAdcode(name) {
    return PROVINCE_ADCODE[name] ?? null;
}
//# sourceMappingURL=world-geo.js.map